...
### 53. echo命令
  ...
  * 输出彩色字符
    ...
    `echo -e \033[31mTEST\033[0m               输出红色TEST`
    
    `echo -e \033[32mTEST\033[0m               输出绿色TEST`
    
   ##### 可见，唯一的区别是第一个\033后的数字m组合代表不同输出颜色或样式
   
   `echo -e \033[43;31mTEST\033[0m        输出黄色背景的红色TEST`
    
   ##### 在数字m组合前加代表背景颜色的代码;如43;可使输出内容带有背景
